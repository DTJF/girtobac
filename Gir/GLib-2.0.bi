...
DECLARE FUNCTION g_hash_table_add(BYVAL AS gpointer, BYVAL AS gpointer) AS gboolean
DECLARE FUNCTION g_hash_table_contains(BYVAL AS gpointer, BYVAL AS gconstpointer) AS gboolean
DECLARE SUB g_hash_table_destroy(BYVAL AS gpointer)
DECLARE FUNCTION g_hash_table_find(BYVAL AS gpointer, BYVAL AS GHRFunc, BYVAL AS gpointer) AS gpointer
DECLARE SUB g_hash_table_foreach(BYVAL AS gpointer, BYVAL AS GHFunc, BYVAL AS gpointer)
DECLARE FUNCTION g_hash_table_foreach_remove(BYVAL AS gpointer, BYVAL AS GHRFunc, BYVAL AS gpointer) AS guint
DECLARE FUNCTION g_hash_table_foreach_steal(BYVAL AS gpointer, BYVAL AS GHRFunc, BYVAL AS gpointer) AS guint
DECLARE FUNCTION g_hash_table_get_keys(BYVAL AS gpointer) AS GList PTR
DECLARE FUNCTION g_hash_table_get_keys_as_array(BYVAL AS gpointer, BYVAL AS guint PTR) AS gpointer PTR
DECLARE FUNCTION g_hash_table_get_values(BYVAL AS gpointer) AS GList PTR
DECLARE FUNCTION g_hash_table_insert(BYVAL AS gpointer, BYVAL AS gpointer, BYVAL AS gpointer) AS gboolean
DECLARE FUNCTION g_hash_table_lookup(BYVAL AS gpointer, BYVAL AS gconstpointer) AS gpointer
DECLARE FUNCTION g_hash_table_lookup_extended(BYVAL AS gpointer, BYVAL AS gconstpointer, BYVAL AS gpointer PTR, BYVAL AS gpointer PTR) AS gboolean
DECLARE FUNCTION g_hash_table_new(BYVAL AS GHashFunc, BYVAL AS GEqualFunc) AS gpointer
DECLARE FUNCTION g_hash_table_new_full(BYVAL AS GHashFunc, BYVAL AS GEqualFunc, BYVAL AS GDestroyNotify, BYVAL AS GDestroyNotify) AS gpointer
DECLARE FUNCTION g_hash_table_ref(BYVAL AS gpointer) AS gpointer
DECLARE FUNCTION g_hash_table_remove(BYVAL AS gpointer, BYVAL AS gconstpointer) AS gboolean
DECLARE SUB g_hash_table_remove_all(BYVAL AS gpointer)
DECLARE FUNCTION g_hash_table_replace(BYVAL AS gpointer, BYVAL AS gpointer, BYVAL AS gpointer) AS gboolean
DECLARE FUNCTION g_hash_table_size(BYVAL AS gpointer) AS guint
DECLARE FUNCTION g_hash_table_steal(BYVAL AS gpointer, BYVAL AS gconstpointer) AS gboolean
DECLARE SUB g_hash_table_steal_all(BYVAL AS gpointer)
DECLARE SUB g_hash_table_unref(BYVAL AS gpointer)
TYPE _GHashTableIter
  ...
  AS gpointer dummy6
END TYPE
DECLARE FUNCTION g_hash_table_iter_get_hash_table(BYVAL AS GHashTableIter PTR) AS gpointer
DECLARE SUB g_hash_table_iter_init(BYVAL AS GHashTableIter PTR, BYVAL AS gpointer)
...
DECLARE SUB g_key_file_set_list_separator(BYVAL AS GKeyFile PTR, BYVAL AS gint8)
...
DECLARE FUNCTION g_string_append_c(BYVAL AS GString PTR, BYVAL AS gint8) AS GString PTR
...
DECLARE FUNCTION g_string_insert_c(BYVAL AS GString PTR, BYVAL AS gssize, BYVAL AS gint8) AS GString PTR
...
DECLARE FUNCTION g_string_prepend_c(BYVAL AS GString PTR, BYVAL AS gint8) AS GString PTR
...
DECLARE FUNCTION g_ascii_digit_value(BYVAL AS gint8) AS gint
...
DECLARE FUNCTION g_ascii_tolower(BYVAL AS gint8) AS gint8
DECLARE FUNCTION g_ascii_toupper(BYVAL AS gint8) AS gint8
DECLARE FUNCTION g_ascii_xdigit_value(BYVAL AS gint8) AS gint
DECLARE SUB g_assert_warning(BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS const gint32 /'int'/, BYVAL AS const char PTR, BYVAL AS const char PTR)
...
DECLARE SUB g_assertion_message_cmpnum(BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS gint /'int'/, BYVAL AS const char PTR, BYVAL AS const char PTR, BYVAL AS double /'long double'/, BYVAL AS const char PTR, BYVAL AS double /'long double'/, BYVAL AS char)
...
DECLARE FUNCTION g_strcanon(BYVAL AS gchar PTR, BYVAL AS const gchar PTR, BYVAL AS gint8) AS gchar PTR
...
DECLARE FUNCTION g_strdelimit(BYVAL AS gchar PTR, BYVAL AS const gchar PTR, BYVAL AS gint8) AS gchar PTR
...
DECLARE FUNCTION g_strnfill(BYVAL AS gsize, BYVAL AS gint8) AS gchar PTR
